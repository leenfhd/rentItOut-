const Notification = require('../model/notificationModel'); // Adjust the path as necessary
...
const markAsRead = async (req, res) => {
    try {
        ...
        db.query(sql,["read",notificationId] ,(error, results) => {
            ...
            db.query(selectSql, [notificationId], (selectError, notificationResults) => {
            if (selectError) {
                console.error("Error retrieving updated notification:", selectError);
                return res.status(500).json({
